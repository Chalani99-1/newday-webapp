...
const routes: Routes = [
  ...
  {path: "", redirectTo: 'login', pathMatch: 'full'},
  {
    ...
    children: [
      ...
      {path: "home/rawmaterial", component: RawmaterialComponent},
      ...
      {path: "home/purchaseorder", component: PurchaseorderComponent},
      {path: "grn", component: GrnComponent},
      {path: "clientorder", component: ClientorderComponent},
      {path: "home/clientorder", component: ClientorderComponent},
      {path: "productionorder", component: ProductionorderComponent},
      {path: "home/productionorder", component: ProductionorderComponent},
