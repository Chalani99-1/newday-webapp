...
export class SuppliercountbymaterialcategoryComponent implements OnInit{
  ...
  ngOnInit(): void {
    ...
    this.rs.supplierCountByMaterialCategory()
      .then((scnt: SupplierCountbymaterialcategory[]) => {
        this.suppliercountbymaterialcategories = scnt;
...
//   //       console.log(this.suppliercountbymaterialcategories);
//   //     }).finally(() => {
//   //     this.loadTable();
//   //     this.loadChartData();
//   //   });
