...
public class Employee {
    ...
    public Collection<Client> getClientsById_0() {
        return clientsById_0;
    }

    public void setClientsById_0(Collection<Client> clientsById_0) {
        this.clientsById_0 = clientsById_0;
    }
    ...
    public Employee(Integer id, String fullname, Emptype emptype, Designation designation) {
        this.id = id;
        this.fullname = fullname;
        this.emptype = emptype;
        this.designation = designation;
