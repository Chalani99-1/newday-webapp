package lk.newdayproducts.security;
...
public class JwtAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    // Step 1: Attempt to authenticate user
    @Override
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException {
        try {
            ...
            else {hashedPassword = loginRequest.getPassword();}

            Authentication auth = authenticationManager
                    .authenticate(new UsernamePasswordAuthenticationToken(loginRequest.getUsername(), hashedPassword));
            return auth;
